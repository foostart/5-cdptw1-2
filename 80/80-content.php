                                ...
                                <div class="sc-service-box wpb_column vc_column_container col-sm-3 vc_col-has-fill">
                                    <div class="vc_column-inner vc_custom_1452516332056">
                                        ...
                                        <div class="" style="text-align:center">
                                            ...
                                            <div class="" style="margin-top:15px;margin-bottom:15px;height:5px;"><span class="uvc-headings-line" style="border-style: solid; border-bottom-width: 5px; border-color: rgb(255, 197, 13); width: 30px; margin: 0px auto;"></span></div>
                                            <div class=""  style="font-family:'Raleway';font-weight:normal;color:#2d2d2d;">
                                                <p> LOrem</p>
                                            </div>
                                        </div>
                                        </div>
