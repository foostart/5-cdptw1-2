                                ...
                                <div class="ult-just-icon-wrapper  ">
                                    <div class="align-icon" style="text-align:center;">
                                        <div class="aio-icon none "
                                            style="color:#666666;font-size:32px;display:inline-block;">
                                    ...
                                    <div class="col-md-3 col-sm-6 col-xs-12">
                                        <div class="" style="text-align:center">
                                            ...
                                            <div class="" style="margin-top:15px;margin-bottom:15px;height:5px;"><span
                                                    ...
                                                    style="border-style: solid; border-bottom-width: 5px; border-color: rgb(255, 197, 13); width: 30px; margin: 0px auto;"></span>
                                            </div>
                                            <div class=""
